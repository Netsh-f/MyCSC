...
public class QueryScore extends Function {
    ...
    public void run(ArrayList<String> parameterList) {
        if (!(parameterList.size() == 0 || parameterList.size() == 1 || parameterList.size() == 2)) {
            ...
            if (UserOperation.isNoUser()) {
                ...
                if (!UserOperation.isManager()) {//如果是学生，那就制定只查自己
                    studentId = UserOperation.getCurrentUser().getId();
                }
